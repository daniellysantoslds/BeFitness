...
struct ListaVersiculosView: View {
    var body: some View {
            ...
            List(versiculos) { versiculo in
                ...
                }.listRowBackground(versiculo.corBackground)
...
var versiculos = [
    ListItem(tituloVersiculo: "Acorda meninaaa",
             descricaoVersiculo: "Bom dia, não deixe para amanhã o que pode ser feito hoje! Sabia que  praticar esportes pela manhã é uma maneira de melhorar o ânimo para o resto do dia. ", turno: "Manhã", cortexto: Color.black, corBackground: Color("corfeliz")),
